...
@app_api.route('/posts/<int:id>/comments/')
def get_post_comments(id):
    ...
    prev = url_for('api.get_post_comments', page=page - 1) if pagination.has_prev else None
    next = url_for('api.get_post_comments', page=page + 1) if pagination.has_next else None
    return jsonify({
